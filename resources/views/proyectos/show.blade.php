...
@section('contenido')
    ...
    <div class="max-w-lg rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <dl class="space-y-3 text-sm">
            <div class="flex flex-col gap-1 border-b border-gray-100 pb-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-col gap-1 pb-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-6 flex flex-col gap-3 sm:flex-row">
            <a href="{{ route('proyectos.edit', $proyecto->id) }}" class="rounded-lg bg-amber-500 px-4 py-2 text-center text-sm font-medium text-white hover:bg-amber-600">
                Editar
            </a>
            <a href="{{ route('proyectos.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-center text-sm font-medium text-gray-600 hover:bg-gray-50">
                Volver al listado
            </a>
        </div>
